...
const canLogin = computed(() => page.props.auth.user === null)
const canRegister = computed(() => page.props.auth.user === null)
...
<template>
    ...
    <div
        ...
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            <Link v-if="$page.props.auth.user" :href="route('employee.dashboard')"
            ...
            <template v-else>
                ...
                <Link v-if="canRegister" :href="route('employee.register')"
